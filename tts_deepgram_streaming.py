# tts_deepgram_streaming.py - Streaming websocket template for deepgram
...
async def streaming_test():
    try:
        t0 = time.time()
        ws_url = "wss://api.deepgram.com/v1/text-to-speech"
        headers = [('Authorization','Token REPLACE_ME')]
